  ...
  const features = [
    {
      ...
      description: "Solve DSA problems with our powerful built-in code editor supporting multiple programming languages."
    },
    {
      icon: <FiLayers className="w-8 h-8" />,
      title: "Categorized Problems",
      description: "Find problems by difficulty level or topic - from arrays to dynamic programming."
    },
    {
      icon: <FiBookmark className="w-8 h-8" />,
      title: "Smart Bookmarking",
      description: "Save interesting problems and track your progress with our intelligent bookmarking system."
    }
  ];
      ...
      >
        <motion.div variants={itemVariants} className="text-center">
          <motion.h1 
            ...
            style={{
              background: "linear-gradient(to right, #646cff, #535bf2, #646cff)",
