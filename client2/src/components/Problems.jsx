              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-white/5">
                    <th className="px-6 py-4 text-left text-gray-700 dark:text-gray-200 font-semibold">Status</th>
                    <th className="px-6 py-4 text-left text-gray-700 dark:text-gray-200 font-semibold">Title</th>
                    <th className="px-6 py-4 text-left text-gray-700 dark:text-gray-200 font-semibold">Difficulty</th>
                    <th className="px-6 py-4 text-left text-gray-700 dark:text-gray-200 font-semibold">Topics</th>
                  </tr>
                </thead>
                <tbody>
